...
use \qCal\Parse\Reader as Reader;

class ReaderUnitTest extends \qCal\UnitTest\TestCase {
...
END:VCALENDAR
ICALDATA;
        $this->reader = new Reader\StringReader($this->data);
    ...
    public function testGetCharReturnsFalseAtEndOfFile() {
        ...
        $reader = new Reader\StringReader('foo');
    ...
    public function testReadFromFile() {
        ...
        $reader = new Reader\FileReader('data/lukeschedule.ics');
    ...
    public function testHandleNonExistentFile() {
        ...
        $reader = new Reader\FileReader($filename);
    
    }
    
    public function testFileReaderGetCharReturnsFalseAtEndOfFile() {
    
        $reader = new Reader\FileReader('data/bastille-day.ics');
        $i = 0;
        while($i < 282) {
            $char = $reader->getChar();
            $i++;
